...
console.log(
    "Firmy tylko IT: ",
    companies.filter((com) => com.kategoria == "IT")
);

console.log(
    "Firmy które rozpoczęły i zakończyły działalność w latach 90:",
    companies.filter((com) => com.poczatek >= 1990 && com.koniec < 2000)
);

console.log(
    "Firmy funkcjonujące dłużej niż 10 lat: ",
    companies.filter((com) => com.koniec - com.poczatek > 10)
);
